          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Create pages in HTML, CSS and React—no coding required. Relax
                with an ad‑free game and get help from our built‑in AI
                assistant.
              </p>
              <div className="mt-6 flex gap-3">
                ...
                <a
                  href="#builder"
                  className="inline-flex items-center rounded-md bg-primary px-4 py-2 text-primary-foreground shadow hover:bg-primary/90"
                >
                  Start Building
                </a>
                <a
